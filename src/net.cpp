...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Lulzcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"lulzcoin.com", "dnsseed.lulzcoin.com"},
...
static const char *strTestNetDNSSeed[][2] = {
	{"lulzcoin.com", "testnet-dnsseed.lulzcoin.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Lulzcoin is probably already running."), addrBind.ToString().c_str());
        else
